...
function setReply(m){state.reply=m;$('#replyBar').hidden=false;$('#replyAuthor').textContent=nameOf(state.profiles.get(m.sender_id));$('#replyText').textContent=m.image_path?'📷 Imagen':m.body||'Mensaje'} $('#cancelReply').onclick=()=>{state.reply=null;$('#replyBar').hidden=true};
